...
app.post('/bid', function(req, res) {
    ...
    if ((bidprice * bidqty <= req.session.cash) && (/^\d+$/.test(bidprice)) && (/^\d+$/.test(bidqty))) { // check the wallet and do the validation
...
app.post('/ask', function(req, res) {
    ...
    if ((askprice * askqty <= req.session.shares) && (/^\d+$/.test(askprice)) && (/^\d+$/.test(askqty))) { // check the wallet and do the validation    
